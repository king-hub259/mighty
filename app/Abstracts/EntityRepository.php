...
abstract class EntityRepository implements CrudInterface, DBPrepareInterface
{
    ...
    {
        if ($this->table == 'institutes' || $this->table == 'plans' || $this->table == 'feedback' || $this->table == 's_a_a_s_faqs' || $this->table == 's_a_a_s_subscriptions') {
        ...
        return DB::table($this->table)->where("{$this->table}.institute_id", $instituteId)->where("{$this->table}.branch_id", $branchId);
    }
