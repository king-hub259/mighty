...
Route::middleware(['auth:api', 'check.subscription'])->group(function () {
    ...
    Route::post('/advance-salary-payment', [PayrollController::class, 'advanceSalaryPayment']);
    Route::post('/advance-salary-pay', [PayrollController::class, 'advanceSalaryPay']);
    Route::get('/due-salary-payment', [PayrollController::class, 'dueSalaryPayment']);
    Route::post('/due-salary-payment', [PayrollController::class, 'dueSalaryPayment']);
    Route::post('/due-salary-pay', [PayrollController::class, 'dueSalaryPay']);
    Route::get('/return-salary-payment', [PayrollController::class, 'returnSalaryPayment']);
    Route::post('/return-salary-payment', [PayrollController::class, 'returnSalaryPayment']);
    Route::post('/return-salary-pay', [PayrollController::class, 'returnSalaryPay']);
