...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('fee-head-delete/{id}', [FeeHeadController::class, 'feeHeadDelete']);

    Route::apiResource('fee-sub-head', FeeSubHeadController::class);
    Route::get('fee-sub-head-delete/{id}', [FeeSubHeadController::class, 'feeSubHeadDelete']);
    ...
    Route::get('unpaid-info', [FeeManagementReportController::class, 'getUnpaidFeeInfo']);
