...
class SelectInstituteImageWidget extends StatelessWidget {
  const SelectInstituteImageWidget({super.key});
      ...
      builder: (instituteController) {
        return Align(alignment: Alignment.center, child: Stack(children: [
          ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
              child: instituteController.thumbnail != null ?  GetPlatform.isWeb? Image.network((instituteController.thumbnail!.path),
                width: 150, height: 120, fit: BoxFit.cover,):Image.file(File(instituteController.thumbnail!.path),
          ...
          Positioned(bottom: 0, right: 0, top: 0, left: 0,
              child: InkWell(onTap: () => instituteController.pickImage(),
