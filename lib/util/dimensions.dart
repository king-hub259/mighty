...
class Dimensions {
  ...
  static double fontSizeExtraOverLarge =  28;
  static double  fontSizeHeading =  20;
  static double fontSizeExtraLargeTwenty = 20;
  ...
  static const double homePageSpacing = 50.0;
  static const double listHeaderHeight = 50.0;
  static const double incrementButton = 35.0;
  static   double splashLogoWidth = 150.0;
  static   double landingPagePadding =  20;
  ...
  static const double profileImageSize = 70;
  static const double productImageSize = 70;
  static const double posProductImageSize = 50;
  static const double imageSize = 30;
  static const double profileWebImageSize = 25;
  static const double imageSizeBig = 40;
  static const double radiusOverLarge = 100.0;
